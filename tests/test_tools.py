...
class ToolingTests(unittest.TestCase):
    ...
    def test_password_privacy_gate_is_origin_bound_and_fail_closed(self):
        ...
        self.assertIn('private const val NEUTRAL_USERNAME = "Passwords"', access)
        self.assertIn('private const val NEUTRAL_PASSWORD = "locked"', access)
        self.assertIn("fun lockedLogins(domain: String, pageUrls: List<String>)", access)
        self.assertIn("fun normalizeWebOrigin", access)
        self.assertIn("fun lockedLookupDomain", access)
        self.assertIn("formActionOrigin = null", access)
        ...
        self.assertIn("PrivatePasswordAccess.lockedLogins", patcher)
        self.assertIn("state.customTabs.map { it.content.url }", patcher)
        self.assertIn("currentLoginOrigin", patcher)
        self.assertIn("lockedLoginLookupDomain", patcher)
        self.assertIn("lockedRequestLogin", patcher)
        self.assertIn("Origin-bound login picker tests", patcher)
        self.assertIn("getByBaseDomain(lookupDomain)", patcher)
